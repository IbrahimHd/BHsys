...
(function () {
    ...
    vizCtrl.$inject = ['$scope', '$ocLazyLoad', '$window', 'dataService', 'debugMode']; //'dc_', 

    function vizCtrl($scope, $ocLazyLoad, $window, dataService, debugMode) { //dc_, 
        var debugThis = false;
        ...
        $ocLazyLoad.load(['scripts/libs/leaflet/leaflet.css',
        ...
        .then(function () {
            ...
            debugMode && debugThis && console.log(receiptAccountsByMonth.all());
            stackChart
