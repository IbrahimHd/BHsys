(function () {
    angular
        .module('app')
        .directive('buttonSpinner', ["$compile", function ($compile) {
        "use strict";
        ...
        return {
            ...
            "<span ng-if=\"!!buttonPrepend\" ng-show=\"spinning\"><i class=\"{{ !!spinningIcon ? spinningIcon : 'fa fa-spinner fa-pulse' }}\"></i>&nbsp;</span>" +
